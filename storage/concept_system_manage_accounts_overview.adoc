...
summary: SolidFire 스토리지 시스템에서 테넌트는 계정을 사용하여 클라이언트가 클러스터의 볼륨에 연결하도록 할 수 있습니다.  SolidFire 스토리지 시스템의 클러스터 관리자 계정도 관리할 수 있습니다. 
---
= 계정 관리
:allow-uri-read: 
:icons: font
...
* link:concept_system_manage_manage_cluster_administrator_users.html["클러스터 관리자 사용자 계정 관리"]
