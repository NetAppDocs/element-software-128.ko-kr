...
summary: ResetSupplementalTlsCiphers 메서드를 사용하면 보충 TLS 암호 목록을 기본값으로 복원할 수 있습니다.  이 방법은 클러스터 전체에 사용할 수 있습니다. 
---
...
[role="lead"]
당신은 사용할 수 있습니다 `ResetSupplementalTlsCiphers` 보충 TLS 암호 목록을 기본값으로 복원하는 방법입니다.  이 방법은 클러스터 전체에 사용할 수 있습니다.
