...
summary: GetIdpAuthenticationState 메서드를 사용하면 타사 IdP를 사용한 인증 상태에 대한 정보를 반환할 수 있습니다. 
---
...
[role="lead"]
당신은 사용할 수 있습니다 `GetIdpAuthenticationState` 타사 IdP를 사용하여 인증 상태에 대한 정보를 반환하는 방법입니다.
...
활성화됨
 a| 
타사 IdP 인증이 활성화되어 있는지 여부를 나타냅니다.
 a| 
부울
