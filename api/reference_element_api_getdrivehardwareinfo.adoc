...
summary: GetDriveHardwareInfo 메서드를 사용하면 지정된 드라이브에 대한 모든 하드웨어 정보를 얻을 수 있습니다.  여기에는 일반적으로 제조업체, 공급업체, 버전 및 기타 관련 하드웨어 식별 정보가 포함됩니다. 
---
= 드라이브 하드웨어 정보 가져오기
:allow-uri-read: 
:icons: font
...
[role="lead"]
당신은 사용할 수 있습니다 `GetDriveHardwareInfo` 지정된 드라이브에 대한 모든 하드웨어 정보를 가져오는 방법입니다.  여기에는 일반적으로 제조업체, 공급업체, 버전 및 기타 관련 하드웨어 식별 정보가 포함됩니다.
...
결과
 a| 
지정된 driveID에 대한 하드웨어 정보를 반환했습니다.
 a| 
