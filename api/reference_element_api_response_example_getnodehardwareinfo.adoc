...
summary: iSCSI에 대한 GetNodeHardwareInfo 메서드는 다음 예와 유사한 응답을 반환합니다. 
---
= GetNodeHardwareInfo(iSCSI에 대한 출력)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
그만큼 `GetNodeHardwareInfo` iSCSI에 대한 메서드는 다음 예와 유사한 응답을 반환합니다.
