...
summary: AddVolumesToVolumeAccessGroup 메서드를 사용하면 지정된 볼륨 액세스 그룹에 볼륨을 추가할 수 있습니다. 
---
= 볼륨 액세스 그룹에 볼륨 추가
:allow-uri-read: 
:icons: font
...
[role="lead"]
당신은 사용할 수 있습니다 `AddVolumesToVolumeAccessGroup` 지정된 볼륨 액세스 그룹에 볼륨을 추가하는 방법입니다.
