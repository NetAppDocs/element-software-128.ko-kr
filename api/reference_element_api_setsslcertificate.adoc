...
summary: SetSSLCertificate 메서드를 사용하면 클러스터의 스토리지 노드에 대한 사용자 SSL 인증서와 개인 키를 설정할 수 있습니다. 
---
= SSL 인증서 설정
:allow-uri-read: 
:icons: font
...
[role="lead"]
당신은 사용할 수 있습니다 `SetSSLCertificate` 클러스터의 스토리지 노드에 대한 사용자 SSL 인증서와 개인 키를 설정하는 방법입니다.
