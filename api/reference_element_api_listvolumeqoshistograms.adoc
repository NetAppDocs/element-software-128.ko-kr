...
summary: ListVolumeQoSHistograms 메서드를 사용하면 하나의 볼륨 또는 여러 볼륨에 대한 볼륨 QoS 사용에 대한 히스토그램을 생성할 수 있습니다.  이를 통해 볼륨이 QoS를 어떻게 사용하는지 더 잘 이해할 수 있습니다. 
---
...
[role="lead"]
당신은 사용할 수 있습니다 `ListVolumeQoSHistograms` 한 볼륨 또는 여러 볼륨에 대한 볼륨 QoS 사용에 대한 히스토그램을 생성하는 방법입니다.  이를 통해 볼륨이 QoS를 어떻게 사용하는지 더 잘 이해할 수 있습니다.
...
볼륨 ID
 a| 
QoS 히스토그램을 생성할 볼륨을 지정하는 볼륨 ID의 선택적 목록입니다.
 a| 
정수 배열
 a| 
None
...
qos히스토그램
 a| 
하나 이상의 볼륨에 대한 볼륨 사용을 설명하는 개체 목록입니다.
 a| 
JSON 객체 배열
