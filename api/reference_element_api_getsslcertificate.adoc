...
summary: GetSSLCertificate 메서드를 사용하면 클러스터의 스토리지 노드에서 현재 활성화된 SSL 인증서를 검색할 수 있습니다. 
---
= SSL 인증서 받기
:allow-uri-read: 
:icons: font
...
[role="lead"]
당신은 사용할 수 있습니다 `GetSSLCertificate` 클러스터의 스토리지 노드에서 현재 활성화된 SSL 인증서를 검색하는 방법입니다.
