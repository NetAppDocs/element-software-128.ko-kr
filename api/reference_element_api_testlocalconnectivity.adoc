...
summary: 'TestLocalConnectivity 메서드를 사용하면 활성 클러스터의 각 노드의 클러스터 IP \(CIP\)를 ping할 수 있습니다.' 
---
= 로컬 연결 테스트
:allow-uri-read: 
:icons: font
...
[role="lead"]
당신은 사용할 수 있습니다 `TestLocalConnectivity` 활성 클러스터의 각 노드의 클러스터 IP(CIP)를 ping하는 방법입니다.
...
세부
 a| 
로컬 활성 클러스터의 각 노드에 대한 개별 ping 응답 시간입니다.
 a| 
JSON 객체
