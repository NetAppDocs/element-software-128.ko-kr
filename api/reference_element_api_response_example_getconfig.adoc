...
summary: GetConfig 메서드는 다음 예와 유사한 응답을 반환합니다.  길이가 길어서 응답에는 클러스터의 한 노드에 대한 정보만 포함됩니다. 
---
= GetConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
그만큼 `GetConfig` 이 메서드는 다음 예와 비슷한 응답을 반환합니다.  길이가 길어서 응답에는 클러스터의 한 노드에 대한 정보만 포함됩니다.
