...
summary: ListGroupSnapshots 메서드를 사용하면 생성된 모든 그룹 스냅샷에 대한 정보를 반환할 수 있습니다. 
---
= ListGroupSnapshots
:allow-uri-read: 
:icons: font
...
[role="lead"]
사용할 수 있습니다 `ListGroupSnapshots` 생성된 모든 그룹 스냅샷에 대한 정보를 반환하는 방법입니다.
...
볼륨
 a| 
쿼리할 고유한 볼륨 ID 배열입니다.  이 매개변수를 지정하지 않으면 클러스터의 모든 그룹 스냅샷이 포함됩니다.
 a| 
volumeID 배열
 a| 
None
...
그룹 스냅샷
 a| 
각 그룹 스냅샷에 대한 정보가 포함된 개체 목록입니다.
 a| 
xref:reference_element_api_groupsnapshot.adoc[그룹스냅샷]정렬
