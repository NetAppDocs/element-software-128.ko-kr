...
summary: GetIpmiConfig 메서드를 사용하면 노드에 있는 센서에서 하드웨어 센서 정보를 검색할 수 있습니다. 
---
= GetIpmiConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
당신은 사용할 수 있습니다 `GetIpmiConfig` 노드에 있는 센서에서 하드웨어 센서 정보를 검색하는 방법입니다.
...
* all: 각 섀시 유형에 대한 센서 정보를 반환합니다.
* {섀시 유형}: 지정된 섀시 유형에 대한 센서 정보를 반환합니다.
